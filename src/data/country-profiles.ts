...
export const COUNTRY_PROFILES: Record<string, CountryProfile> = {
  AD: {
    ...
    intro:
      "A high-altitude tax haven nestled in the Pyrenees offering world-class skiing, mountain hiking, and duty-free shopping luxury.",
  ...
  AE: {
    ...
    capital: "Abu Dhabi",
    intro:
      "A futuristic oasis blending Bedouin heritage with soaring skyscrapers, golden deserts, and unparalleled luxury shopping experiences.",
    bestSeason: "Nov–Mar",
  ...
  AF: {
    ...
    capital: "Kabul",
    intro:
      "A rugged land of ancient history, silk road heritage, and dramatic mountain landscapes currently undergoing complex transitions.",
    ...
    tips: {
      ...
      transport:
        "Internal travel is difficult; check current security advisories before moving between cities.",
  ...
  AG: {
    ...
    capital: "St. John's",
    intro:
      "A tropical paradise boasting 365 white-sand beaches, vibrant coral reefs, and a rich colonial maritime history.",
    bestSeason: "Dec–Apr",
  ...
  AL: {
    ...
    capital: "Tirana",
    intro:
      "Europe’s hidden gem featuring wild mountains, pristine turquoise coastlines, and a fascinating blend of Ottoman and Mediterranean history.",
  ...
  AM: {
    ...
    capital: "Yerevan",
    intro:
      "A land of ancient monasteries, dramatic canyons, and high-altitude lakes settled in the shadow of Mount Ararat.",
    bestSeason: "May–Jun & Sep–Oct",
  ...
  AO: {
    ...
    capital: "Luanda",
    intro:
      "An emerging frontier offering vast wildlife parks, dramatic coastal cliffs, and a unique Luso-African cultural fusion.",
    bestSeason: "Jun–Sep",
  ...
  AR: {
    ...
    intro:
      "A passionate land of tango, world-class steak, and diverse landscapes from glacial Patagonia to colorful Andean peaks.",
  ...
  AT: {
    ...
    capital: "Vienna",
    intro:
      "The imperial heart of Europe featuring grand classical music venues, alpine splendor, and historic coffee house traditions.",
  ...
  AU: {
    ...
    capital: "Canberra",
    intro:
      "A vast continent of unique wildlife, vibrant coastal cities, ancient rainforests, and the iconic red Outback.",
  ...
  AZ: {
    ...
    capital: "Baku",
    intro:
      "A captivating 'Land of Fire' where ultra-modern skyscrapers meet historic silk road villages and bubbling mud volcanoes.",
    bestSeason: "Apr–Jun & Sep–Oct",
  ...
  BA: {
    ...
    capital: "Sarajevo",
    intro:
      "A heart-shaped land of stunning waterfalls, Ottoman history, and resilient spirit at the crossroads of East and West.",
  ...
  BB: {
    ...
    capital: "Bridgetown",
    intro:
      "A quintessential Caribbean paradise blending British colonial history with world-class surf, golden sands, and legendary rum punch culture.",
    bestSeason: "Dec–Apr",
  ...
  BD: {
    ...
    capital: "Dhaka",
    intro:
      "A vibrant delta nation of endless river paths, the world's largest mangrove forest, and incredible hospitality.",
    bestSeason: "Nov–Feb",
  ...
  BE: {
    ...
    capital: "Brussels",
    intro:
      "Europe’s political heart charms visitors with medieval squares, surrealist art, and the world's finest chocolate and craft ales.",
    bestSeason: "May–Sep",
    currency: "Euro (EUR)",
    ...
    attractions: [
      {
        name: "Grand Place",
        blurb:
          "Breathtaking UNESCO-listed central square surrounded by ornate 17th-century guildhalls.",
        emoji: "🏛️",
      },
      {
        name: "Canals of Bruges",
        blurb:
          "Fairytale waterways winding through one of Europe's best-preserved medieval cities.",
        emoji: "🛶",
      },
      {
        name: "Atomium",
  ...
  BF: {
    ...
    capital: "Ouagadougou",
    intro:
      "A West African cultural hub renowned for its vibrant music, expansive arts festivals, and warm, welcoming spirit.",
    bestSeason: "Nov–Feb",
    ...
    attractions: [
      ...
      },
      {
        ...
        blurb:
          "Traditional Kassena houses decorated with intricate, hand-painted geometric patterns.",
        emoji: "🎨",
      },
      {
  ...
  BG: {
    ...
    capital: "Sofia",
    intro:
      "Eastern Europe’s hidden gem offers affordable ski resorts, Black Sea beaches, and ancient Roman ruins nestled in Balkan mountains.",
    ...
    attractions: [
      ...
      },
      {
        name: "Rila Monastery",
        blurb:
          "Stunning 10th-century spiritual retreat decorated with colorful, detailed frescoes.",
        emoji: "🎨",
      },
      {
  ...
  BH: {
    ...
    capital: "Manama",
    intro:
      "An island kingdom merging rich Dilmun heritage with a modern, cosmopolitan skyline and a passion for Formula 1.",
    bestSeason: "Nov–Mar",
  ...
  BI: {
    ...
    capital: "Gitega",
    intro:
      "The beating heart of Africa, home to the hypnotic Royal Drummers and the misty shores of Lake Tanganyika.",
    bestSeason: "Jun–Aug",
    ...
    attractions: [
      {
        ...
        blurb:
          "Crystal clear waters offering beach relaxation and incredible freshwater biodiversity.",
        emoji: "🏖️",
      },
      {
      ...
      },
      {
        ...
        blurb:
          "Experience the powerful, rhythmic performance of the world-famous Burundian drummers.",
        emoji: "🥁",
      },
      {
        name: "Kigwena Forest",
  ...
  BJ: {
    ...
    capital: "Porto-Novo",
    intro:
      "The cradle of Voodoo culture, featuring stilt villages, palm-fringed coasts, and a complex history at the Ouidah slave port.",
    bestSeason: "Nov–Feb",
    currency: "West African CFA franc (XOF)",
  ...
  BN: {
    ...
    intro:
      "A serene sultanate on Borneo, boasting opulent gold-domed mosques and pristine, untouched rainforests.",
    bestSeason: "Jan–May",
  ...
  BO: {
    ...
    intro:
      "From the surreal Uyuni salt flats to the dizzying heights of La Paz, Bolivia offers raw, breathtaking Andean beauty.",
    bestSeason: "May–Oct",
  ...
  BR: {
    ...
    capital: "Brasília",
    intro:
      "A colossal land of samba, Amazonian biodiversity, and iconic beaches, pulsing with incomparable energy and tropical heat.",
    bestSeason: "Dec–Mar",
  ...
  BS: {
    ...
    capital: "Nassau",
    intro:
      "An archipelago of 700 islands offering turquoise waters, world-class diving, and a relaxed, rhythmic island lifestyle.",
    bestSeason: "Dec–Apr",
  ...
  BT: {
    ...
    capital: "Thimphu",
    intro:
      "The Himalayan Kingdom of Bhutan offers a mystical journey through ancient monasteries and pristine landscapes where Gross National Happiness prevails.",
    ...
    tips: {
      ...
      culture:
        "Dress conservatively and remove shoes when entering temples or administrative buildings.",
  ...
  BW: {
    ...
    capital: "Gaborone",
    intro:
      "A premier safari destination where the Kalahari Desert meets the lush, wildlife-rich waterways of the Okavango Delta.",
    bestSeason: "May–Sep",
  ...
  BY: {
    ...
    capital: "Minsk",
    intro:
      "A land of dense primeval forests, Soviet-era architecture, and grand fortresses waiting to be discovered by intrepid travelers.",
    bestSeason: "May–Sep",
  ...
  BZ: {
    ...
    capital: "Belmopan",
    intro:
      "Belize blends Caribbean vibes with Central American jungles, featuring the Northern Hemisphere's largest barrier reef and ancient Mayan ruins.",
    bestSeason: "Nov–Apr",
  ...
  CA: {
    ...
    capital: "Ottawa",
    intro:
      "From the rugged Rockies to vibrant cosmopolitan hubs, Canada spans a continent with breathtaking natural wonders and friendly charm.",
    bestSeason: "Jun–Aug & Dec–Mar",
  ...
  CD: {
    ...
    capital: "Kinshasa",
    intro:
      "The Democratic Republic of the Congo is a wild frontier of immense biodiversity, featuring active volcanoes and rare gorillas.",
    bestSeason: "May–Sep",
  ...
  CF: {
    ...
    capital: "Bangui",
    intro:
      "Off the beaten path, the Central African Republic protects some of the continent's most pristine and remote rainforest ecosystems.",
    bestSeason: "Nov–Mar",
  ...
  CG: {
    ...
    capital: "Brazzaville",
    intro:
      "The Republic of the Congo offers accessible tropical adventures, stylish cities, and the lush Congo River banks.",
    bestSeason: "Jun–Sep",
    currency: "CFA Franc (XAF)",
  ...
  CH: {
    ...
    capital: "Bern",
    intro:
      "Switzerland is a precision-engineered paradise of emerald lakes, soaring Alps, and charming alpine villages.",
  ...
  CI: {
    ...
    intro:
      "Côte d'Ivoire features golden beaches, French-colonial history, and the world's largest basilica amidst cacao plantations.",
    bestSeason: "Nov–Mar",
    currency: "CFA Franc (XAF)",
    language: "French",
    timezone: "UTC+0",
  ...
  CL: {
    ...
    capital: "Santiago",
    intro:
      "A thin ribbon of a country stretching from the arid Atacama Desert to the icy fjords of Patagonia.",
    bestSeason: "Oct–Mar",
  ...
  CM: {
    ...
    capital: "Yaoundé",
    intro:
      "Known as 'Africa in miniature,' Cameroon boasts diverse landscapes ranging from volcanic mountains to palm-lined coastlines.",
    bestSeason: "Nov–Feb",
    currency: "CFA Franc (XAF)",
  ...
  CN: {
    ...
    capital: "Beijing",
    intro:
      "A vast tapestry of ancient dynastic history, hyper-modern megacities, and diverse landscapes stretching from the Himalayas to the Pacific.",
  ...
  CO: {
    ...
    capital: "Bogotá",
    intro:
      "Experience the vibrant rhythm of salsa, high-altitude coffee plantations, and the colorful colonial streets of the Caribbean coast.",
    bestSeason: "Dec–Mar",
  ...
  CR: {
    ...
    capital: "San José",
    intro:
      "A sustainable paradise of cloud forests, active volcanoes, and incredible biodiversity where the 'Pura Vida' lifestyle reigns supreme.",
    bestSeason: "Dec–Apr",
  ...
  CU: {
    ...
    capital: "Havana",
    intro:
      "A nostalgic time capsule defined by vintage cars, crumbling Spanish architecture, and the soulful sounds of Son and Mambo.",
    bestSeason: "Dec–Mar",
  ...
  CV: {
    ...
    capital: "Praia",
    intro:
      "Ten volcanic islands in the Atlantic offering a unique blend of African rhythm, Portuguese history, and dramatic volcanic scenery.",
    bestSeason: "Nov–Jun",
  ...
  CY: {
    ...
    capital: "Nicosia",
    intro:
      "The sunshine-filled birthplace of Aphrodite where blue-flag beaches meet ancient ruins and a divided, fascinating capital city.",
    bestSeason: "Apr–Jun & Sep–Oct",
    currency: "Euro (EUR)",
  ...
  CZ: {
    ...
    capital: "Prague",
    intro:
      "A fairytale central European heartland boasting gothic spires, hearty cuisine, and the world's most famous brewery traditions.",
    bestSeason: "May–Jun & Sep–Oct",
  ...
  DE: {
    ...
    capital: "Berlin",
    intro:
      "A powerhouse of culture and industry offering everything from buzzing techno clubs to romantic Rhine Valley castles.",
    bestSeason: "May–Sep",
    currency: "Euro (EUR)",
    language: "German",
    timezone: "UTC+1",
  ...
  DJ: {
    ...
    capital: "Djibouti",
    intro:
      "A raw, otherworldly landscape of salt lakes, volcanic plains, and whale shark nurseries at the horn of Africa.",
    bestSeason: "Nov–Mar",
  ...
  DK: {
    ...
    capital: "Copenhagen",
    intro:
      "The home of 'Hygge', minimalist design, and bicycle-filled streets across a network of flat, windy islands.",
    bestSeason: "Jun–Aug",
  ...
  DM: {
    ...
    capital: "Roseau",
    intro:
      "The 'Nature Island' of the Caribbean, covered in lush rainforests, steaming hot springs, and spectacular volcanic peaks.",
    bestSeason: "Nov–May",
    currency: "East Caribbean Dollar (XCD)",
  ...
  DO: {
    ...
    intro:
      "A Caribbean jewel where turquoise waters meet colonial history and the vibrant energy of Merengue and Bachata.",
    bestSeason: "Dec–Apr",
  ...
  DZ: {
    ...
    capital: "Algiers",
    intro:
      "A vast North African frontier where Roman ruins overlook the Mediterranean and golden Sahara dunes stretch toward the horizon.",
    bestSeason: "Oct–Apr",
  ...
  EC: {
    ...
    capital: "Quito",
    intro:
      "Experience four worlds in one nation, from Andean peaks and Amazon jungles to the unique wildlife of the Galapagos Islands.",
    bestSeason: "Jun–Sep",
  ...
  EE: {
    ...
    capital: "Tallinn",
    intro:
      "A digital-forward nation blending fairy-tale medieval architecture with wild forests and a stunning Baltic coastline.",
    bestSeason: "May–Aug",
    currency: "Euro (EUR)",
    language: "Estonian",
    timezone: "UTC+2",
  ...
  EG: {
    ...
    capital: "Cairo",
    intro:
      "The cradle of civilization, where mighty pyramids and the timeless Nile River tell the story of ancient pharaohs.",
    bestSeason: "Oct–Apr",
  ...
  ER: {
    ...
    capital: "Asmara",
    intro:
      "A hidden gem featuring Art Deco treasures, high-altitude landscapes, and a unique blend of African and Italian influences.",
    bestSeason: "Oct–Mar",
    ...
    attractions: [
      {
        ...
        blurb:
          "Exceptional Italian modernist architecture throughout this UNESCO-listed capital city.",
        emoji: "🏢",
      },
      {
      ...
      },
      {
        name: "Massawa",
        blurb:
          "An evocative port town featuring Ottoman, Egyptian, and Italian architectural styles.",
        emoji: "⚓",
      },
      {
        name: "Qohaito",
  ...
  ES: {
    ...
    capital: "Madrid",
    intro:
      "A passionate land of diverse regions, world-class art, architectural wonders, and a sun-soaked Mediterranean lifestyle.",
    bestSeason: "Apr–Jun & Sep–Oct",
    currency: "Euro (EUR)",
    ...
    attractions: [
      {
        ...
        blurb:
          "Gaudí’s unfinished masterpiece with soaring spires and kaleidoscopic stained glass.",
        emoji: "🏗️",
      },
      {
        name: "The Alhambra",
  ...
  ET: {
    ...
    capital: "Addis Ababa",
    intro:
      "An ancient empire of dramatic highlands, rock-hewn churches, and the proud source of the world's coffee culture.",
    bestSeason: "Oct–Mar",
    ...
    attractions: [
      {
        name: "Lalibela",
        blurb:
          "Thirteen remarkable medieval monolithic churches carved entirely out of solid rock.",
        emoji: "⛪",
      },
      {
  ...
  FI: {
    ...
    capital: "Helsinki",
    intro:
      "The world's happiest country, where modern design meets vast archipelagos and the magical Northern Lights.",
    bestSeason: "Jun–Aug & Dec–Mar",
    currency: "Euro (EUR)",
  ...
  FJ: {
    ...
    capital: "Suva",
    intro:
      "A tropical paradise of 333 islands known for vibrant coral reefs, soft white sands, and incomparable hospitality.",
    bestSeason: "May–Oct",
  ...
  FM: {
    ...
    capital: "Palikir",
    intro:
      "An emerald archipelago in the North Pacific offering incredible diving and mysterious ancient stone cities.",
    bestSeason: "Dec–Apr",
    currency: "US Dollar (USD)",
    language: "English",
    timezone: "UTC+10 & +11",
  ...
  FR: {
    ...
    capital: "Paris",
    intro:
      "The world’s most visited country, celebrated for its iconic landmarks, exquisite cuisine, and timeless art.",
    bestSeason: "Apr–Jun & Sep–Oct",
    currency: "Euro (EUR)",
    language: "French",
    timezone: "UTC+1",
  ...
  GA: {
    ...
    capital: "Libreville",
    intro:
      "Africa's 'Last Eden', where pristine rainforests meet the Atlantic and elephants roam along the beach.",
  ...
  GB: {
    ...
    capital: "London",
    intro:
      "A tapestry of royal history, rolling green hills, and vibrant cities blending ancient heritage with cutting-edge modern culture.",
    bestSeason: "May–Sep",
  ...
  GD: {
    ...
    capital: "St. George's",
    intro:
      "Known as the Spice Isle, this lush volcanic paradise offers fragrant air, turquoise waters, and hidden rainforest waterfalls.",
    bestSeason: "Jan–May",
    currency: "East Caribbean Dollar (XCD)",
    language: "English",
    timezone: "UTC-4",
  ...
  GE: {
    ...
    capital: "Tbilisi",
    intro:
      "At the crossroads of Europe and Asia, Georgia dazzles with Caucasus peaks, ancient monasteries, and legendary amber wine.",
    bestSeason: "May–Jun & Sep–Oct",
  ...
  GH: {
    ...
    capital: "Accra",
    intro:
      "A beacon of stability in West Africa, Ghana offers rich Ashanti heritage, sobering history, and golden Atlantic beaches.",
    bestSeason: "Nov–Feb",
  ...
  GM: {
    ...
    capital: "Banjul",
    intro:
      "Enveloping the Gambia River, this narrow country is a birdwatcher's paradise with sun-soaked beaches and friendly riverside towns.",
    bestSeason: "Nov–Feb",
  ...
  GN: {
    ...
    capital: "Conakry",
    intro:
      "From the Fouta Djallon highlands to the wild coast, Guinea offers raw adventure for the intrepid traveler seeking nature.",
    bestSeason: "Nov–Mar",
    ...
    attractions: [
      {
        name: "Fouta Djallon",
        blurb:
          "Stunning plateau featuring dramatic waterfalls, cliffs, and excellent hiking trails.",
        emoji: "🥾",
      },
      {
        name: "Îles de Los",
  ...
  GQ: {
    ...
    capital: "Malabo",
    intro:
      "Central Africa’s only Spanish-speaking nation, Equatorial Guinea features pristine rainforests and distinct colonial architecture across island and mainland.",
    bestSeason: "Dec–Feb",
  ...
  GR: {
    ...
    capital: "Athens",
    intro:
      "Where ancient myths come to life amidst sun-drenched islands, azure seas, and the white-washed charm of the Mediterranean.",
    bestSeason: "Apr–Jun & Sep–Oct",
    currency: "Euro (EUR)",
    language: "Greek",
    timezone: "UTC+2",
  ...
  GT: {
    ...
    intro:
      "A land of eternal spring, where Mayan ruins emerge from jungles and colorful markets thrive under smoke-drifting volcanoes.",
    bestSeason: "Nov–Apr",
    ...
    attractions: [
      ...
      },
      {
        name: "Antigua",
        blurb:
          "UNESCO-listed colonial city featuring cobblestone streets and colorful crumbling ruins.",
        emoji: "🏘️",
      },
      {
  ...
  GW: {
    ...
    capital: "Bissau",
    intro:
      "Languid rivers and the unspoiled Bijagós islands define this hidden West African gem where matriarchal traditions still flourish.",
    bestSeason: "Nov–Feb",
    currency: "West African CFA Franc (XOF)",
    language: "Portuguese, Crioulo",
    timezone: "UTC+0",
    ...
    tips: {
      ...
      culture:
        "Traditional beliefs are strong; always respect local chiefs when visiting villages.",
  ...
  GY: {
    ...
    capital: "Georgetown",
    intro:
      "South America’s only English-speaking country offers vast pristine rainforests, thundering waterfalls, and a unique Caribbean-style culture.",
  ...
  HK: {
    ...
    capital: "Hong Kong",
    intro:
      "A high-octane metropolis where neon-lit skyscrapers meet traditional temples and green mountain trails meet the South China Sea.",
    bestSeason: "Oct–Dec",
  ...
  HN: {
    ...
    capital: "Tegucigalpa",
    intro:
      "A Central American gem where Mayan ruins meet turquoise Caribbean waters and lush mountainous coffee plantations.",
    bestSeason: "Dec–Apr",
    ...
    tips: {
      ...
      culture:
        "Respect local modesty and avoid discussing sensitive political history with strangers.",
  ...
  HR: {
    ...
    capital: "Zagreb",
    intro:
      "Where sun-drenched Adriatic coastline meets medieval walled cities and cascading turquoise waterfalls.",
  ...
  HT: {
    ...
    intro:
      "A resilient nation boasting vibrant Caribbean art, historic fortresses, and a rich, complex cultural heritage.",
    bestSeason: "Nov–Mar",
  ...
  HU: {
    ...
    capital: "Budapest",
    intro:
      "A central European treasure famous for grand architecture, thermal baths, and the winding Danube River.",
    bestSeason: "May–Jun & Sep–Oct",
  ...
  ID: {
    ...
    capital: "Jakarta",
    intro:
      "A vast archipelago of thousands of islands offering tropical jungles, volcanic peaks, and ancient temples.",
    bestSeason: "May–Sep",
  ...
  IE: {
    ...
    capital: "Dublin",
    intro:
      "The Emerald Isle enchants with rugged Atlantic cliffs, ancient folklore, and exceptionally warm hospitality.",
    bestSeason: "Jun–Aug",
    currency: "Euro (EUR)",
  ...
  IL: {
    ...
    capital: "Jerusalem",
    intro:
      "A land of profound history and modern innovation where sacred sites meet vibrant Mediterranean beaches.",
    bestSeason: "Apr–May & Sep–Oct",
  ...
  IN: {
    ...
    capital: "New Delhi",
    intro:
      "A sensory explosion of vibrant colors, ancient spirituality, and diverse landscapes from Himalayas to tropical shores.",
    bestSeason: "Oct–Mar",
  ...
  IQ: {
    ...
    capital: "Baghdad",
    intro:
      "The cradle of civilization, where the Tigris and Euphrates rivers frame millennia of human history.",
  ...
  IR: {
    ...
    capital: "Tehran",
    intro:
      "A land of breathtaking Islamic architecture, ancient Persian ruins, and legendary hospitality.",
  ...
  IS: {
    ...
    capital: "Reykjavik",
    intro:
      "The land of fire and ice offers dramatic volcanic landscapes, massive glaciers, and ethereal northern lights.",
  ...
  IT: {
    ...
    capital: "Rome",
    intro:
      "An unparalleled open-air museum where ancient history, world-class art, and exquisite cuisine converge.",
    bestSeason: "Apr–Jun & Sep–Oct",
    currency: "Euro (EUR)",
    language: "Italian",
    timezone: "UTC+1",
  ...
  JM: {
    ...
    capital: "Kingston",
    intro:
      "A rhythmic island paradise of reggae beats, jerk-spiced cuisine, and misty Blue Mountains surrounded by crystal-clear Caribbean waters.",
    bestSeason: "Dec–Apr",
    ...
    attractions: [
      {
        ...
        blurb:
          "Terraced waterfalls cascading directly into the Caribbean Sea for climbing adventures.",
        emoji: "🌊",
      },
      {
  ...
  JO: {
    ...
    capital: "Amman",
    intro:
      "An ancient kingdom where rose-red desert cities meet the buoyant Dead Sea and the hospitable traditions of Bedouin culture.",
    bestSeason: "Mar–May & Sep–Nov",
  ...
  JP: {
    ...
    capital: "Tokyo",
    intro:
      "A seamless blend of neon-lit futurism and serene ancient temples, defined by impeccable hospitality and world-class culinary mastery.",
  ...
  KE: {
    ...
    capital: "Nairobi",
    intro:
      "The ultimate safari destination where the Great Migration thunders across the savannah beneath the watchful eye of Mount Kenya.",
    ...
    attractions: [
      {
        name: "Maasai Mara",
        blurb:
          "Premier wildlife reserve hosting lions, cheetahs, and the vast wildebeest migration.",
        emoji: "🦁",
      },
      {
  ...
  KG: {
    ...
    capital: "Bishkek",
    intro:
      "A rugged Central Asian gem defined by the celestial Tian Shan mountains, nomadic yurt stays, and alpine lakes.",
    bestSeason: "Jun–Sep",
    ...
    attractions: [
      ...
      },
      {
        name: "Ala Archa",
        blurb:
          "Spectacular national park featuring glaciers and rugged hiking trails near Bishkek.",
        emoji: "🏔️",
      },
      {
        name: "Song-Kul",
  ...
  KH: {
    ...
    capital: "Phnom Penh",
    intro:
      "Home to the awe-inspiring Angkor Wat, Cambodia enchants with its resilient spirit, jungle-clad ruins, and Mekong River charm.",
    bestSeason: "Nov–Feb",
    ...
    attractions: [
      {
        name: "Angkor Wat",
        blurb:
          "The massive, iconic temple complex representing the pinnacle of Khmer architecture.",
        emoji: "🏰",
      },
      {
        name: "Ta Prohm",
  ...
  KI: {
    ...
    intro:
      "A remote Pacific nation of sprawling coral atolls offering world-class fishing and a front-row seat to climate change impacts.",
    bestSeason: "May–Oct",
    currency: "Australian Dollar (AUD)",
  ...
  KM: {
    ...
    capital: "Moroni",
    intro:
      "The 'Perfume Isles' of the Indian Ocean, blending volcanic landscapes with Arabic heritage and scents of ylang-ylang.",
    bestSeason: "May–Oct",
  ...
  KN: {
    ...
    capital: "Basseterre",
    intro:
      "A dual-island nation where lush rainforests, historic sugar plantations, and dormant volcanoes meet golden Caribbean shores.",
    bestSeason: "Dec–Apr",
    currency: "East Caribbean Dollar (XCD)",
    language: "English",
    timezone: "UTC-4",
  ...
  KP: {
    ...
    capital: "Pyongyang",
    intro:
      "The world's most reclusive nation, accessible only through strictly controlled state-sanctioned tours under constant supervision.",
    bestSeason: "May–Jun & Sep–Oct",
  ...
  KR: {
    ...
    capital: "Seoul",
    intro:
      "A high-tech powerhouse where K-pop energy meets peaceful Buddhist temples and incredibly flavorful street food culture.",
  ...
  KW: {
    ...
    capital: "Kuwait City",
    intro:
      "A wealthy Gulf state where modern skyscrapers overlook traditional dhow harbors and a deep-rooted merchant history.",
    bestSeason: "Nov–Mar",
  ...
  KZ: {
    ...
    capital: "Astana",
    intro:
      "Central Asia's giant offers surreal steppe landscapes, futuristic architecture, and ancient Silk Road history across its vast, rugged terrain.",
    bestSeason: "May–Jun & Sep–Oct",
  ...
  LA: {
    ...
    capital: "Vientiane",
    intro:
      "Languid and spiritual, Laos invites you to discover misty mountains, saffron-robed monks, and the mighty Mekong River's rhythm.",
    bestSeason: "Nov–Feb",
    ...
    attractions: [
      ...
      },
      {
        name: "Plain of Jars",
        blurb:
          "Mysterious archaeological site featuring thousands of prehistoric giant stone jars.",
        emoji: "🏺",
      },
      {
        name: "Vang Vieng",
  ...
  LB: {
    ...
    capital: "Beirut",
    intro:
      "A Mediterranean jewel blending ancient Phoenician ruins with a vibrant, modern nightlife and world-renowned culinary heritage.",
    bestSeason: "Apr–Jun & Sep–Nov",
    ...
    attractions: [
      ...
      },
      {
        name: "Jeita Grotto",
        blurb:
          "Breathtaking interconnected limestone caves featuring a subterranean river boat ride.",
        emoji: "🚣",
      },
      {
        name: "Byblos",
  ...
  LC: {
    ...
    capital: "Castries",
    intro:
      "Dominated by the iconic Piton peaks, this Caribbean paradise boasts lush rainforests, sulfur springs, and volcanic black sand beaches.",
    bestSeason: "Dec–Apr",
    currency: "East Caribbean Dollar (XCD)",
    language: "English, French Patois",
    timezone: "UTC-4",
  ...
  LI: {
    ...
    capital: "Vaduz",
    intro:
      "Nestled in the Alps between Switzerland and Austria, this microstate offers fairytale castles and pristine mountain trails.",
    bestSeason: "Jun–Aug & Dec–Mar",
    currency: "Swiss Franc (CHF)",
    language: "German",
    timezone: "UTC+1",
  ...
  LK: {
    ...
    capital: "Colombo",
    intro:
      "A teardrop-shaped island featuring ancient ruins, emerald tea plantations, and elephant-filled national parks along the Indian Ocean.",
  ...
  LR: {
    ...
    capital: "Monrovia",
    intro:
      "Africa's oldest republic offers sprawling surf beaches, dense tropical rainforests, and a resilient, welcoming spirit in West Africa.",
    bestSeason: "Nov–Apr",
  ...
  LS: {
    ...
    capital: "Maseru",
    intro:
      "Known as the Kingdom in the Sky, this landlocked nation is defined by its high-altitude peaks and traditional Basotho culture.",
    bestSeason: "Oct–Apr",
  ...
  LT: {
    ...
    capital: "Vilnius",
    intro:
      "A Baltic gem featuring a Baroque capital, haunting historical sites, and the shifting sand dunes of the Curonian Spit.",
    bestSeason: "May–Sep",
    currency: "Euro (EUR)",
    language: "Lithuanian",
    timezone: "UTC+2",
    ...
    attractions: [
      ...
      },
      {
        name: "Užupis",
        blurb:
          "Bohemian district in Vilnius that declared itself an independent artistic republic.",
        emoji: "🎨",
      },
      {
        name: "Curonian Spit",
  ...
  LU: {
    ...
    intro:
      "Tiny but powerful, this Grand Duchy offers fairytale gorges, medieval fortifications, and sophisticated cosmopolitan charm.",
    bestSeason: "May–Sep",
    currency: "Euro (EUR)",
  ...
  LV: {
    ...
    capital: "Riga",
    intro:
      "A land of sprawling forests, wild Baltic beaches, and a capital city renowned for its stunning Art Nouveau architecture.",
    bestSeason: "Jun–Aug",
    currency: "Euro (EUR)",
    language: "Latvian",
    timezone: "UTC+2",
  ...
  LY: {
    ...
    capital: "Tripoli",
    intro:
      "Home to incredible Roman ruins and vast Saharan dunes, Libya is a destination for the intrepid historical explorer.",
    bestSeason: "Oct–Apr",
    ...
    attractions: [
      ...
      },
      {
        ...
        blurb:
          "Spectacular desert landscapes featuring thousands of prehistoric rock art carvings.",
        emoji: "🏜️",
      },
    ],
    tips: {
  ...
  MA: {
    ...
    capital: "Rabat",
    intro:
      "A vibrant tapestry of bustling souks, Sahara dunes, and ancient medinas where traditions meet the cooling Atlantic breeze.",
    bestSeason: "Mar–May & Sep–Nov",
    ...
    attractions: [
      {
        name: "Jemaa el-Fnaa",
        blurb:
          "Marrakech's legendary square filled with musicians, storytellers, and street food stalls.",
        emoji: "🐍",
      },
      {
        name: "Chefchaouen",
      ...
      },
      {
        ...
        blurb:
          "Massive Casablanca landmark featuring a minaret overlooking the crashing Atlantic ocean.",
        emoji: "🕌",
      },
    ],
    tips: {
  ...
  MC: {
    ...
    capital: "Monaco",
    intro:
      "The world's second-smallest nation offers unparalleled glamour, high-stakes casinos, and a prestigious yacht-lined harbor.",
    bestSeason: "Apr–Jun & Sep–Oct",
    currency: "Euro (EUR)",
    language: "French",
    timezone: "UTC+1",
  ...
  MD: {
    ...
    capital: "Chișinău",
    intro:
      "Europe’s hidden gem boasts world-class underground wine cellars, rolling green hills, and quiet, rural charm.",
    bestSeason: "May–Jun & Sep–Oct",
  ...
  ME: {
    ...
    capital: "Podgorica",
    intro:
      "Where dramatic mountains plunge into the Adriatic, offering medieval walled towns and breathtaking glacial lakes.",
    bestSeason: "May–Sep",
    currency: "Euro (EUR)",
  ...
  MG: {
    ...
    intro:
      "An ecological wonderland home to unique lemurs, towering baobabs, and diverse landscapes found nowhere else on Earth.",
    bestSeason: "Apr–Oct",
    ...
    attractions: [
      ...
      },
      {
        ...
        blurb:
          "Striking limestone needle formations offering adventurous hiking across suspension bridges.",
        emoji: "🧗",
      },
      {
  ...
  MH: {
    ...
    capital: "Majuro",
    intro:
      "Low-lying coral atolls offering world-class diving and a serene escape in the remote central Pacific.",
    bestSeason: "Jan–Apr",
    currency: "US Dollar (USD)",
  ...
  MK: {
    ...
    capital: "Skopje",
    intro:
      "A Balkan treasure where Ottoman history, Byzantine churches, and the stunning Lake Ohrid await adventurous travelers.",
    bestSeason: "May–Jun & Sep–Oct",
  ...
  ML: {
    ...
    capital: "Bamako",
    intro:
      "The heart of West African music and history, featuring iconic mud-brick architecture and the majestic Niger River.",
    bestSeason: "Nov–Jan",
    currency: "West African CFA Franc (XOF)",
    ...
    attractions: [
      ...
      },
      {
        name: "Dogon Country",
        blurb:
          "Spectacular Bandiagra Escarpment with traditional cliff-side villages and unique culture.",
        emoji: "👺",
      },
      {
  ...
  MM: {
    ...
    capital: "Naypyidaw",
    intro:
      "A spiritual landscape of thousands of golden pagodas, misty mountains, and the unique stilt-villages of Inle Lake.",
    bestSeason: "Nov–Feb",
  ...
  MN: {
    ...
    capital: "Ulaanbaatar",
    intro:
      "The land of the eternal blue sky offers vast steppes, nomadic hospitality, and the wild Gobi Desert.",
    bestSeason: "Jun–Aug",
  ...
  MO: {
    ...
    capital: "Macau",
    intro:
      "A unique blend of Portuguese heritage and glittering mega-casinos, known as the 'Las Vegas of Asia.'",
    bestSeason: "Oct–Dec",
  ...
  MR: {
    ...
    capital: "Nouakchott",
    intro:
      "A bridge between the Maghreb and Sub-Saharan Africa, where desert caravans meet the Atlantic's rich fishing waters.",
    bestSeason: "Nov–Mar",
  ...
  MT: {
    ...
    capital: "Valletta",
    intro:
      "A sun-drenched Mediterranean archipelago where prehistoric temples meet crystal-clear waters and honey-colored limestone fortresses.",
    bestSeason: "Apr–Jun & Sep–Oct",
    currency: "Euro (EUR)",
  ...
  MU: {
    ...
    capital: "Port Louis",
    intro:
      "A volcanic island nation in the Indian Ocean famous for sapphire waters, powder-white beaches, and diverse fusion cuisine.",
    bestSeason: "May–Dec",
  ...
  MV: {
    ...
    capital: "Malé",
    intro:
      "A tropical paradise of over a thousand coral islands offering ultimate luxury, white sands, and vibrant marine life.",
    bestSeason: "Nov–Apr",
  ...
  MW: {
    ...
    capital: "Lilongwe",
    intro:
      "The Warm Heart of Africa captivates visitors with its massive lake, lush mountains, and exceptionally friendly people.",
    bestSeason: "May–Oct",
  ...
  MX: {
    ...
    capital: "Mexico City",
    intro:
      "A vibrant kaleidoscope of ancient ruins, colonial cities, world-class cuisine, and stunning coastlines across two oceans.",
    bestSeason: "Dec–Apr",
  ...
  MY: {
    ...
    intro:
      "A diverse melting pot where futuristic skyscrapers tower over ancient rainforests and bustling multi-ethnic street markets.",
  ...
  MZ: {
    ...
    capital: "Maputo",
    intro:
      "An unexplored jewel of East Africa boasting 2,500 kilometers of pristine coastline and a rhythmic Afro-Portuguese culture.",
    bestSeason: "May–Nov",
  ...
  NA: {
    ...
    capital: "Windhoek",
    intro:
      "A land of hauntingly beautiful desert landscapes, towering red dunes, and unique wildlife adapted to the arid terrain.",
    bestSeason: "Jun–Oct",
  ...
  NE: {
    ...
    capital: "Niamey",
    intro:
      "A vast Saharan nation where ancient caravan routes meet the Great Niger River and nomadic traditions endure.",
    bestSeason: "Dec–Feb",
    currency: "West African CFA franc (XOF)",
  ...
  NG: {
    ...
    capital: "Abuja",
    intro:
      "The Giant of Africa pulsates with energy, legendary nightlife, diverse cultures, and a rapidly growing creative scene.",
    bestSeason: "Nov–Jan",
  ...
  NI: {
    ...
    capital: "Managua",
    intro:
      "The land of lakes and volcanoes offers colonial charm, world-class surfing, and lush untamed rainforests.",
    bestSeason: "Dec–Apr",
  ...
  NL: {
    ...
    capital: "Amsterdam",
    intro:
      "A charming landscape of iconic windmills, seasonal tulip fields, historic canals, and a progressive, bike-friendly culture.",
    bestSeason: "Apr–May & Sep–Oct",
    currency: "Euro (EUR)",
    language: "Dutch",
    timezone: "UTC+1",
  ...
  NO: {
    ...
    capital: "Oslo",
    intro:
      "A majestic Nordic kingdom where dramatic fjords, midnight sun, and the dancing aurora borealis create an outdoor enthusiast's paradise.",
    bestSeason: "Jun–Aug & Dec–Mar",
    ...
    attractions: [
      {
        name: "Geirangerfjord",
        blurb:
          "Deep blue UNESCO-protected fjord surrounded by majestic snow-capped peaks and waterfalls.",
        emoji: "🏔️",
      },
      {
        name: "Lofoten Islands",
        blurb:
          "Dramatic archipelago known for fishing villages, surfing, and northern lights displays.",
        emoji: "🛶",
      },
      {
        name: "Preikestolen",
  ...
  NP: {
    ...
    capital: "Kathmandu",
    intro:
      "The roof of the world, offering spiritual temples and the planet's highest peaks for ultimate trekking adventures.",
    ...
    attractions: [
      {
        ...
        blurb:
          "The legendary trekking destination sitting at the foot of Earth's highest mountain.",
        emoji: "🧗",
      },
      {
    ...
    tips: {
      ...
      transport:
        "Domestic flights are convenient but prone to weather-related delays and cancellations.",
  ...
  NR: {
    ...
    intro:
      "A tiny, remote island nation in the central Pacific known for its unique phosphate cliffs and aviation history.",
    bestSeason: "May–Oct",
    currency: "Australian Dollar (AUD)",
  ...
  NZ: {
    ...
    capital: "Wellington",
    intro:
      "A breathtaking island nation of cinematic landscapes, geothermal wonders, and rich Maori heritage at the edge of the world.",
    ...
    attractions: [
      {
        name: "Milford Sound",
        blurb:
          "Stunning fiord featuring Mitre Peak, rainforests, and towering cascading waterfalls.",
        emoji: "🚢",
      },
      {
      ...
      },
      {
        name: "Rotorua",
        blurb:
          "Geothermal wonderland filled with bubbling mud pools and explosive natural fountains.",
        emoji: "🌋",
      },
      {
  ...
  OM: {
    ...
    capital: "Muscat",
    intro:
      "An Arabian gem where ancient forts, vast desert dunes, and a turquoise coastline preserve traditional Gulf charm.",
    bestSeason: "Oct–Apr",
    ...
    attractions: [
      {
        ...
        blurb:
          "Architectural masterpiece featuring a massive Persian carpet and Swarovski chandelier.",
        emoji: "🕌",
      },
      {
        name: "Wahiba Sands",
  ...
  PA: {
    ...
    capital: "Panama City",
    intro:
      "The bridge between two oceans, blending ultra-modern skyscrapers with lush rainforests and incredible engineering feats.",
    bestSeason: "Dec–Apr",
  ...
  PE: {
    ...
    capital: "Lima",
    intro:
      "A land of ancient Incan mysteries, vibrant Andean textiles, and some of the world's most celebrated culinary innovations.",
    bestSeason: "May–Oct",
    currency: "Sol (PEN)",
  ...
  PG: {
    ...
    intro:
      "One of the most culturally diverse places on Earth, offering rugged mountains and untouched underwater ecosystems for intrepid explorers.",
    bestSeason: "May–Oct",
    currency: "Kina (PGK)",
  ...
  PH: {
    ...
    capital: "Manila",
    intro:
      "An archipelago of 7,000+ islands famed for powder-white beaches, emerald rice terraces, and incredibly friendly locals.",
    bestSeason: "Dec–Feb",
  ...
  PK: {
    ...
    capital: "Islamabad",
    intro:
      "A land of unparalleled mountain scenery, ancient silk road history, and legendary hospitality in every valley.",
  ...
  PL: {
    ...
    capital: "Warsaw",
    intro:
      "A resilient nation blending medieval Old Towns, somber history, and a modern, vibrant cultural scene.",
    bestSeason: "May–Jun & Sep–Oct",
  ...
  PS: {
    ...
    intro:
      "A land of profound religious significance, ancient olive groves, and deeply rooted traditions amidst a complex landscape.",
    bestSeason: "Mar–May & Oct–Nov",
  ...
  PT: {
    ...
    capital: "Lisbon",
    intro:
      "A sun-drenched coastal gem where melancholic fado music echoes through historic cobblestone streets and golden Atlantic beaches await discovery.",
    bestSeason: "Apr–Jun & Sep–Oct",
    currency: "Euro (EUR)",
    language: "Portuguese",
    timezone: "UTC+0",
  ...
  PW: {
    ...
    capital: "Ngerulmud",
    intro:
      "An untouched Pacific paradise famous for its limestone islands, vibrant coral reefs, and the surreal experience of swimming with jellyfish.",
    bestSeason: "Dec–Apr",
    currency: "US Dollar (USD)",
  ...
  PY: {
    ...
    capital: "Asunción",
    intro:
      "The 'Heart of South America' offers an authentic and off-the-beaten-path experience through its colonial history and vast wilderness.",
    bestSeason: "May–Sep",
  ...
  QA: {
    ...
    capital: "Doha",
    intro:
      "Where futuristic skyscrapers meet ancient desert traditions, offering luxury shopping, stunning architecture, and warm Arabian hospitality.",
    bestSeason: "Nov–Mar",
    ...
    attractions: [
      ...
      },
      {
        ...
        blurb:
          "An artificial island featuring Mediterranean-style yacht-lined boardwalks and villas.",
        emoji: "🛥️",
      },
      {
        name: "Khor Al Adaid",
  ...
  RO: {
    ...
    capital: "Bucharest",
    intro:
      "A land of breathtaking Carpathian peaks, medieval Saxon towns, and the legend-infused castles of misty Transylvania.",
    bestSeason: "May–Jun & Sep–Oct",
  ...
  RS: {
    ...
    capital: "Belgrade",
    intro:
      "Dynamic Belgrade meets tranquil monasteries and rugged nature in this spirited Balkan crossroads of history and nightlife.",
    bestSeason: "May–Sep",
  ...
  RU: {
    ...
    capital: "Moscow",
    intro:
      "The world's largest nation spans eleven time zones, featuring imperial palaces, the Trans-Siberian railway, and deep literary traditions.",
    bestSeason: "Jun–Aug",
  ...
  RW: {
    ...
    capital: "Kigali",
    intro:
      "The 'Land of a Thousand Hills' is a clean, green, and inspiring destination famous for its rare mountain gorillas.",
    bestSeason: "Jun–Sep",
  ...
  SA: {
    ...
    capital: "Riyadh",
    intro:
      "A rapidly transforming kingdom opening its doors to show off hidden Nabataean cities and spectacular desert landscapes.",
    bestSeason: "Nov–Feb",
  ...
  SB: {
    ...
    capital: "Honiara",
    intro:
      "A spectacular archipelago for adventurers, offering world-class diving among WWII wrecks and pristine coral reefs.",
    bestSeason: "May–Oct",
  ...
  SC: {
    ...
    capital: "Victoria",
    intro:
      "An idyllic archipelago of 115 islands featuring granite boulders, turquoise waters, and some of the world's best beaches.",
  ...
  SD: {
    ...
    capital: "Khartoum",
    intro:
      "A land of ancient archaeological wonders, featuring more pyramids than Egypt and the merging points of the mighty Nile.",
    bestSeason: "Nov–Feb",
  ...
  SE: {
    ...
    capital: "Stockholm",
    intro:
      "A bastion of Scandinavian style where pristine archipelagos, medieval towns, and the magical Aurora Borealis define the landscape.",
  ...
  SG: {
    ...
    capital: "Singapore",
    intro:
      "A futuristic city-state where soaring supertrees and colonial architecture meet world-class dining in a lush tropical garden setting.",
    bestSeason: "Feb–Apr",
  ...
  SI: {
    ...
    capital: "Ljubljana",
    intro:
      "Europe’s hidden green gem, offering alpine peaks, turquoise rivers, and a fairy-tale lake within a single hour's drive.",
    bestSeason: "May–Sep",
    currency: "Euro (EUR)",
    language: "Slovenian",
    timezone: "UTC+1",
  ...
  SL: {
    ...
    capital: "Freetown",
    intro:
      "A West African treasure boasting palm-fringed white beaches, lush rainforests, and a powerful history of resilience.",
    bestSeason: "Nov–Apr",
    currency: "Leone (SLE)",
  ...
  SM: {
    ...
    capital: "San Marino",
    intro:
      "The world's oldest republic, perched atop Mount Titano, offering sweeping Italian vistas and medieval fortifications.",
  ...
  SN: {
    ...
    capital: "Dakar",
    intro:
      "A vibrant hub of Teranga hospitality, renowned for its soulful music, colorful markets, and Pink Lake.",
    bestSeason: "Nov–May",
    currency: "West African CFA Franc (XOF)",
  ...
  SO: {
    ...
    capital: "Mogadishu",
    intro:
      "A nation with the longest coastline in Africa, featuring ancient coral stone ruins and pristine white beaches.",
    bestSeason: "Dec–Feb",
  ...
  SR: {
    ...
    capital: "Paramaribo",
    intro:
      "A multicultural South American secret covered in dense Amazonian rainforest and colonial Dutch architecture.",
  ...
  SS: {
    ...
    capital: "Juba",
    intro:
      "The world's youngest nation, home to the vast Sudd wetlands and magnificent wildlife migrations.",
    bestSeason: "Nov–Jan",
  ...
  ST: {
    ...
    capital: "São Tomé",
    intro:
      "An emerald island paradise of volcanic peaks, cocoa plantations, and some of the world's rarest birds.",
    bestSeason: "Jun–Sep",
    currency: "Dobra (STN)",
    language: "Portuguese",
    timezone: "UTC+0",
  ...
  SV: {
    ...
    intro:
      "The land of volcanoes and world-class surf, packing immense natural beauty into Central America’s smallest nation.",
    bestSeason: "Nov–Apr",
  ...
  SY: {
    ...
    capital: "Damascus",
    intro:
      "One of Earth's oldest civilizations, Syria offers layers of history from Roman ruins to legendary souks and ancient desert citadels.",
    bestSeason: "Mar–May & Sep–Nov",
  ...
  SZ: {
    ...
    capital: "Mbabane",
    intro:
      "The Kingdom of Eswatini captivates visitors with rich royal traditions, stunning mountain landscapes, and exceptional wildlife encounters.",
    bestSeason: "May–Sep",
  ...
  TD: {
    ...
    capital: "N'Djamena",
    intro:
      "A land of raw Saharan beauty, Chad features dramatic desert peaks, ancient rock art, and the life-giving waters of Lake Chad.",
    bestSeason: "Nov–Feb",
    currency: "Central African CFA Franc (XAF)",
    language: "French, Arabic",
    timezone: "UTC+1",
  ...
  TG: {
    ...
    capital: "Lomé",
    intro:
      "Togo blends palm-fringed Atlantic beaches with hilly interior forests and the mysterious traditions of West African voodoo culture.",
    bestSeason: "Nov–Feb",
    currency: "West African CFA Franc (XOF)",
  ...
  TH: {
    ...
    capital: "Bangkok",
    intro:
      "The Land of Smiles offers everything from glittering temples and chaotic markets to turquoise bays and world-renowned street food.",
    bestSeason: "Nov–Feb",
  ...
  TJ: {
    ...
    capital: "Dushanbe",
    intro:
      "Tajikistan is a rugged mountaineer's dream, defined by the soaring Pamir Highway and ancient Silk Road Silk hospitality.",
    bestSeason: "Jun–Sep",
  ...
  TL: {
    ...
    capital: "Dili",
    intro:
      "One of the world's youngest nations, Timor-Leste rewards intrepid travelers with pristine coral reefs and misty mountain coffee plantations.",
    bestSeason: "May–Oct",
    currency: "US Dollar (USD)",
  ...
  TM: {
    ...
    capital: "Ashgabat",
    intro:
      "Turkmenistan is a land of fascinating contrasts, from Ashgabat’s white marble architecture to the fiery 'Door to Hell' crater.",
    bestSeason: "Apr–Jun & Sep–Oct",
  ...
  TN: {
    ...
    capital: "Tunis",
    intro:
      "Tunisia invites you to explore grand Roman amphitheaters, Mediterranean beaches, and the golden dunes of the Sahara Desert.",
    bestSeason: "Apr–Jun & Sep–Oct",
  ...
  TO: {
    ...
    capital: "Nukuʻalofa",
    intro:
      "The 'Friendly Islands' of Tonga offer a true Polynesian escape where you can swim with whales and enjoy untouched coral reefs.",
    bestSeason: "May–Oct",
  ...
  TR: {
    ...
    capital: "Ankara",
    intro:
      "Turkey is a bridge between continents, where vibrant bazaars, Byzantine mosaics, and otherworldly landscapes create an unforgettable adventure.",
    bestSeason: "Apr–May & Sep–Oct",
  ...
  TT: {
    ...
    intro:
      "Trinidad and Tobago serve up a rhythmic blend of Caribbean carnival spirit, lush rainforests, and world-class bird watching.",
    bestSeason: "Jan–May",
  ...
  TV: {
    ...
    capital: "Funafuti",
    intro:
      "One of the world's smallest nations, Tuvalu offers a remote Polynesian paradise defined by turquoise lagoons and secluded coral atolls.",
    bestSeason: "May–Oct",
    currency: "Australian Dollar (AUD)",
  ...
  TW: {
    ...
    capital: "Taipei",
    intro:
      "Taiwan is a vibrant island fusion of bustling night markets, soaring skyscrapers, and lush mountain landscapes steeped in tradition.",
    bestSeason: "Oct–Dec",
    ...
    attractions: [
      ...
      },
      {
        name: "Taroko Gorge",
        blurb:
          "Spectacular marble canyons, waterfalls, and tunnels carved through rugged mountains.",
        emoji: "⛰️",
      },
      {
  ...
  TZ: {
    ...
    capital: "Dodoma",
    intro:
      "East Africa’s soul where the massive Serengeti migrations meet the spice-scented white sands of Zanzibar's exotic coastline.",
    bestSeason: "Jun–Oct",
    ...
    attractions: [
      ...
      },
      {
        ...
        blurb:
          "A breathtaking volcanic caldera teeming with dense populations of African wildlife.",
        emoji: "🦏",
      },
      {
        name: "Stone Town",
  ...
  UA: {
    ...
    capital: "Kyiv",
    intro:
      "A resilient land of golden-domed cathedrals, vast sunflower fields, and a deep history currently facing significant modern challenges.",
    bestSeason: "May–Jun & Sep",
    ...
    attractions: [
      {
        ...
        blurb:
          "A stunning 11th-century Byzantine monument featuring intricate mosaics and frescoes.",
        emoji: "⛪",
      },
      {
        name: "Lviv Old Town",
  ...
  UG: {
    ...
    capital: "Kampala",
    intro:
      "The Pearl of Africa invites travelers to trek with mountain gorillas through mist-shrouded rainforests and explore diverse wildlife reserves.",
    bestSeason: "Jun–Aug & Dec–Feb",
  ...
  US: {
    ...
    intro:
      "A vast tapestry of iconic cities, diverse national parks, and cinematic landscapes stretching from the Atlantic to the Pacific.",
    bestSeason: "Apr–Jun & Sep–Oct",
    currency: "US Dollar (USD)",
    ...
    attractions: [
      ...
      },
      {
        name: "Yellowstone",
        blurb:
          "Volcanic wonderland filled with geysers, hot springs, and abundant American wildlife.",
        emoji: "🌋",
      },
      {
    ...
    tips: {
      ...
      safety:
        "Emergency services are excellent, but healthcare is extremely expensive without insurance.",
    },
  },
  UY: {
    code: "UY",
    ...
    capital: "Montevideo",
    intro:
      "South America’s hidden gem offers sophisticated coastal charm, historic colonial towns, and a relaxed, progressive atmosphere for every traveler.",
    bestSeason: "Dec–Mar",
    ...
    attractions: [
      {
        ...
        blurb:
          "Charming UNESCO town with cobblestone streets and Portuguese colonial architecture.",
        emoji: "🏘️",
      },
      {
        name: "Punta del Este",
  ...
  UZ: {
    ...
    capital: "Tashkent",
    intro:
      "The heart of the Silk Road, Uzbekistan dazzles with turquoise-tiled mosques and ancient desert ruins that echo with merchant history.",
    bestSeason: "Apr–Jun & Sep–Oct",
    ...
    tips: {
      ...
      transport:
        "The high-speed Afrosiyob train connects Tashkent, Samarkand, and Bukhara efficiently.",
      safety:
        "Uzbekistan is very safe, though registration slips from hotels are legally required.",
    },
  },
  VA: {
    code: "VA",
    ...
    intro:
      "The world's smallest sovereign state is a spiritual enclave containing an unparalleled collection of Renaissance art and religious history.",
    bestSeason: "Apr–Jun & Sep–Oct",
    currency: "Euro (EUR)",
  ...
  VC: {
    ...
    capital: "Kingstown",
    intro:
      "An emerald archipelago of 32 islands offering lush volcanic peaks, yacht-filled bays, and a true escape from modern life.",
    bestSeason: "Dec–May",
    currency: "East Caribbean Dollar (XCD)",
    language: "English",
    timezone: "UTC-4",
  ...
  VE: {
    ...
    capital: "Caracas",
    intro:
      "Home to the world's tallest waterfall and diverse ecosystems, this nation possesses immense natural beauty despite its political complexity.",
    bestSeason: "Dec–Apr",
    ...
    attractions: [
      ...
      },
      {
        name: "Los Roques",
        blurb:
          "A stunning archipelago archipelago protecting vibrant coral reefs and turquoise lagoons.",
        emoji: "🏝️",
      },
      {
        name: "Mount Roraima",
    ...
    tips: {
      ...
      transport:
        "Internal travel usually requires domestic flights or private transfers for safety.",
      safety:
        "Strictly follow travel advisories and prioritize organized tours for all excursions.",
    },
  },
  VN: {
    code: "VN",
    ...
    capital: "Hanoi",
    intro:
      "A sensory feast of jade waters, emerald rice paddies, and chaotic cities that pulse with energy and culinary magic.",
    bestSeason: "Nov–Apr",
  ...
  VU: {
    ...
    capital: "Port Vila",
    intro:
      "Vibrant Vanuatu offers ancient tribal traditions, active volcanoes, and world-class scuba diving among 83 lush tropical islands.",
    bestSeason: "May–Oct",
  ...
  WS: {
    ...
    capital: "Apia",
    intro:
      "The heart of Polynesia, Samoa enchants visitors with its thunderous waterfalls, deep blue swimming holes, and timeless Fa'a Samoa traditions.",
    bestSeason: "May–Oct",
    ...
    tips: {
      ...
      culture:
        "Dress modestly when walking through villages and avoid walking during evening prayer.",
  ...
  XK: {
    ...
    capital: "Pristina",
    intro:
      "Europe’s youngest country beckons with rugged Balkan peaks, Ottoman-era architecture, and some of the continent’s trendiest coffee culture.",
    bestSeason: "May–Sep",
    currency: "Euro (EUR)",
  ...
  YE: {
    ...
    capital: "Sana'a",
    intro:
      "A land of ancient 'skyscrapers' and unique biodiversity, Yemen holds incredible cultural depth despite current travel restrictions.",
    bestSeason: "Oct–Mar",
  ...
  ZA: {
    ...
    capital: "Pretoria",
    intro:
      "South Africa offers a spectacular mix of wildlife safaris, world-class vineyards, and the dramatic coastline of the Cape.",
    bestSeason: "May–Sep",
  ...
  ZM: {
    ...
    capital: "Lusaka",
    intro:
      "Zambia is the birthplace of the walking safari, boasting raw wilderness and the thunderous majesty of Victoria Falls.",
    bestSeason: "May–Oct",
  ...
  ZW: {
    ...
    capital: "Harare",
    intro:
      "From ancient stone ruins to the spray of the Zambezi, Zimbabwe offers incredible heritage and some of Africa's best guides.",
    bestSeason: "May–Oct",
    currency: "US Dollar (USD)",
...
export function getCountryProfile(code: string, name: string): CountryProfile {
  ...
  return {
    ...
    attractions: [
      {
        name: "Capital highlights",
        blurb: "Historic center, markets, and museums.",
        emoji: "\ud83c\udfdb\ufe0f",
      },
      {
        name: "Natural wonders",
        blurb: "Landscapes and national parks.",
        emoji: "\ud83c\udfde\ufe0f",
      },
      {
        name: "Local cuisine",
        blurb: "Taste the signature national dishes.",
        emoji: "\ud83c\udf7d\ufe0f",
      },
      {
        name: "Cultural sites",
        blurb: "Traditions, festivals, and heritage.",
        emoji: "\ud83c\udfad",
      },
    ],
    tips: {
